...
class CustomUser(AbstractBaseUser):
    ...
    phone_number = models.CharField("Номер телефона", max_length=15, unique=True, blank=False)
...
class Orders(models.Model):
    ...
    file = models.CharField('Имя файла', max_length=250, unique=True, blank=False)
